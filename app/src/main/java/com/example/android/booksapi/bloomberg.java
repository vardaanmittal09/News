...
public class bloomberg extends AppCompatActivity{
    RecyclerView rv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(bloomberg.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),bloomberg.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=bloomberg&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
