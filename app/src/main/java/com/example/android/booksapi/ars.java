...
public class ars extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(ars.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),ars.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=ars-technica&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
