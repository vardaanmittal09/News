...
public class ft extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(ft.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),ft.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=financial-times&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
