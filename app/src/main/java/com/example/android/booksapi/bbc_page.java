...
public class bbc_page extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(bbc_page.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),bbc_page.this);
