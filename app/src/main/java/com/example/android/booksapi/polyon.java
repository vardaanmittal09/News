...
public class polyon extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(polyon.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),polyon.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=polygon&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
