...
public class engadget extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(engadget.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),engadget.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=engadget&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
