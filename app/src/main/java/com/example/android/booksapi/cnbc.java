...
public class cnbc extends AppCompatActivity{
    RecyclerView rv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(cnbc.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),cnbc.this);
        ...
        downloadTask.execute(" https://newsapi.org/v1/articles?source=cnbc&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
