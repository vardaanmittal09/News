...
public class hacker extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(hacker.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),hacker.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=hacker-news&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
