...
public class weekly extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(weekly.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),weekly.this);
        ...
        downloadTask.execute(" https://newsapi.org/v1/articles?source=entertainment-weekly&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
