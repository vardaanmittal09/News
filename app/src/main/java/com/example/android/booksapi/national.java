...
public class national extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(national.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),national.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=national-geographic&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbbs");
    }
}
