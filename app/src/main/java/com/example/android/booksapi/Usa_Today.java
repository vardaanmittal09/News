...
public class Usa_Today extends AppCompatActivity{
    RecyclerView rv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(Usa_Today.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),Usa_Today.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
