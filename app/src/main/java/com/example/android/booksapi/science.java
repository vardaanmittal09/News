...
public class science extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),science.this);
        ...
        downloadTask.execute(" https://newsapi.org/v1/articles?source=new-scientist&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
