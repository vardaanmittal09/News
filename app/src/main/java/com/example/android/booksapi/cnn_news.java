...
public class cnn_news extends AppCompatActivity{
    RecyclerView rv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.startingpage);
            ...
            progressDialog = new ProgressDialog(cnn_news.this);
            ...
            final NewsAdapter newsAdapter = new NewsAdapter(new ArrayList<News>(), cnn_news.this);
            ...
            downloadTask.execute("https://newsapi.org/v1/articles?source=cnn&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
