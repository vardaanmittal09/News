...
public class mtv extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(mtv.this);
        ...
        final NewsAdapter newsAdapter=new NewsAdapter(new ArrayList<News>(),mtv.this);
        ...
        downloadTask.execute("https://newsapi.org/v1/articles?source=mtv-news&sortBy=top&apiKey=1b3ac87f366640c9b665affec166ddbb");
    }
}
